...
// spec: example/tests/TEST_PLAN.md - Test Scenario 11

test.describe("All Navigation Paths from API State", () => {
  test("should navigate to docs overview from API", async ({ page }) => {
  ...
  test("should navigate through all paths from API", async ({ page }) => {
    const factory = createStateFactory(page);
    const executor = new ModelExecutor(page, playwrightDevMachine, factory);
