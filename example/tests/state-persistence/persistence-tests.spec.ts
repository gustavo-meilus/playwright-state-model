...
// spec: example/tests/TEST_PLAN.md - Test Scenario 14

test.describe("State Persistence Across Multiple Transitions", () => {
  test("state persists correctly across multiple transitions", async ({
    page,
  }) => {
    ...
    // Navigate: docs.gettingStarted → api
